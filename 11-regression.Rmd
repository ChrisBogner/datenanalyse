...
## Begriff Regression
Woher kommt der Begriff *Regression*? Diesen prägte Sir Francis Galdon (1822-1911) [@Fahrmeir2009]. Galton interessierte sich unter anderem für den Zusammenhang zwischen der durchschnittlichen Körpergröße der Eltern und der Körpergröße ihrer erwachsenen Kinder. Leider war er nicht nur einer der Väter der Statistik, sondern auch ein Rassist.
...
ggplot(model_res, aes(x = anreise, y = zeit_bib)) +
  ...
  geom_abline(intercept = coef(lin_mod)[1], slope = coef(lin_mod)[2], color = "lightgrey") +
...
- Überprüfung der Annahmen (vor allem) graphisch.
