...
mit $n$: Anzahl der Datenpunkte, $p$: Anzahl der Prädiktoren (ohne intercept). $R^2_\text{ajd}$ ist robuster als $R^2$ bei multipler Regression.
...
## Bootstrap für lineare Regression
Die $t$-Verteilung der Schätzungen gilt *asymptotisch*, d.h. bei großen Datensäzten, auch für nicht-normalverteilte Fehler (unter bestimmten Bedingunngen, s. @Fahrmeir2009). Allerdings erfordern 
**nicht-normalverteilte Fehler große Stichproben oder aber alternative Methoden**. Solch eine alternative Methode ist der Bootstrap.
