...
Wir kommen zurück auf die Klausurpunkte aus der Aufgabe \@ref(klausur). Unterscheiden sich die Mittelwerte der erreichten Klausurpunkte zwischen den Gruppen? Nutzen Sie das Framework in `infer`. Lesen Sie die ursprüngliche Aufgabe noch einmal richtig durch, um die Alternativhypothese richtig zu formulieren.
