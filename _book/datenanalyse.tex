...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_data_trans <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{col1_trans =}\NormalTok{ (my_data}\OperatorTok{$}\NormalTok{col1 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col1))}\OperatorTok{/}\KeywordTok{sd}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col1),}
                            \DataTypeTok{col2_trans =}\NormalTok{ (my_data}\OperatorTok{$}\NormalTok{col2 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col2))}\OperatorTok{/}\KeywordTok{sd}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col1),}
                            \DataTypeTok{col3_trans =}\NormalTok{ (my_data}\OperatorTok{$}\NormalTok{col3 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col3))}\OperatorTok{/}\KeywordTok{sd}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col3))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_data_trans_}\DecValTok{2}\NormalTok{ <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{col1_trans =} \KeywordTok{z_transofrm}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col1),}
                              \DataTypeTok{col2_trans =} \KeywordTok{z_transofrm}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col2),}
                              \DataTypeTok{col2_trans =} \KeywordTok{z_transofrm}\NormalTok{(my_data}\OperatorTok{$}\NormalTok{col3))}
\KeywordTok{summary}\NormalTok{(my_data_trans_}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{temp_humid}\OperatorTok{$}\NormalTok{MESS_DATUM <-}\StringTok{ }\KeywordTok{ymd_h}\NormalTok{(temp_humid}\OperatorTok{$}\NormalTok{MESS_DATUM)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{temp_humid }\OperatorTok{%>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{temp_humid }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(STATIONS_ID }\OperatorTok{==}\StringTok{ }\NormalTok{station_ids}\OperatorTok{$}\NormalTok{Koeln) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{count}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Köln-Bonn wählen}
\NormalTok{koeln <-}\StringTok{ }\NormalTok{temp_humid }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(STATIONS_ID }\OperatorTok{==}\StringTok{ }\NormalTok{station_ids}\OperatorTok{$}\NormalTok{Koeln)}
...
\includegraphics{datenanalyse_files/figure-latex/unnamed-chunk-53-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{temp_humid <-}\StringTok{ }\KeywordTok{mutate}\NormalTok{(temp_humid, }
                     \DataTypeTok{year =} \KeywordTok{year}\NormalTok{(temp_humid}\OperatorTok{$}\NormalTok{MESS_DATUM),}
                     \DataTypeTok{month =} \KeywordTok{month}\NormalTok{(temp_humid}\OperatorTok{$}\NormalTok{MESS_DATUM))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{monthly_means <-}\StringTok{ }\NormalTok{monthly_means }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{my_date =} \KeywordTok{parse_date_time}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(monthly_means}\OperatorTok{$}\NormalTok{year,}
\NormalTok{                  monthly_means}\OperatorTok{$}\NormalTok{month), }\StringTok{'ym'}\NormalTok{, }\DataTypeTok{tz =} \StringTok{'CET'}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{datenanalyse_files/figure-latex/unnamed-chunk-59-1.pdf}
